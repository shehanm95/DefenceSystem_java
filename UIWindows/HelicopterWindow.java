...
public class HelicopterWindow extends SuperDefense implements UnitObserver {
    GreenUnit unit;
    public HelicopterWindow(SelectionButton selectionButton, GreenUnit greenUnit, String unitNumber) {
