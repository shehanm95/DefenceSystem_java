...
public interface MsgReceivable {
    ...
    default void receiveMessage(MsgReceivable sender, JTextArea text){
       ...
       if(msgDisplayArea.getText().length() == 0) msgDisplayArea.setText(String.format("%-15s :  %s",sender.getSenderName(), text.getText()));
       else msgDisplayArea.setText(msgDisplayArea.getText() + "\n" + String.format("%-15s :  %s",sender.getSenderName(), text.getText()));
